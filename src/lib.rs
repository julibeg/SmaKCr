...
pub trait CountKmers {
    ...
    /// threads and update the corresponding count vectors in the [PerThreadVec].
    ///
...
impl CountKmers for FastxReader {
    ...
    /// counting across multiple threads. Each thread updates its assigned count vector within the
    /// [PerThreadVec].
    fn count_kmers_parallel(
        self,
        k: usize,
